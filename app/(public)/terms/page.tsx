...
const sections = [
  ...
  {
    title: "5. Course Enrollment & Licence",
    content:
  ...
  {
    title: "6. Payments, Billing & Taxes",
    content:
  ...
  {
    title: "8. Live Classes & Third-Party Integrations",
    content:
    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-muted/30 px-4 py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mb-10 leading-relaxed text-muted-foreground">
          ...
          enrolling in any course. By using the Platform, you agree to these Terms.
        </p>
