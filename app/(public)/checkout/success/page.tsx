  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl items-center px-4 py-10">
      <section className="w-full space-y-4 rounded-xl border border-slate-200 bg-white p-6 text-center sm:p-8">
        ...
        <h1 className="text-2xl font-bold text-slate-900">Pick a course to continue.</h1>
        <p className="text-slate-600">
          Payments are now instant via Paystack. Open a course to choose a plan and unlock lessons right away.
        </p>
