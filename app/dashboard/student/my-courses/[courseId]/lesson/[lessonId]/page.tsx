...
export default function LessonViewPage() {
  ...
  if (!isUnlocked) {
    return (
      <div className="space-y-4 rounded-md border border-slate-200 bg-white p-6 text-center">
        <h2 className="text-lg font-semibold text-slate-900">This lesson is locked</h2>
        <p className="text-slate-600">Unlock it to start learning. You can pay for just this lesson or the whole course.</p>
        <Button
          type="button"
          onClick={() => router.push(`/courses/${params.courseId}/checkout?lesson=${params.lessonId}`)}
        >
          Unlock this lesson
        </Button>
      </div>
